...
- Windows NSIS install/remove: hosted x64 **PASS**, including residue-check remediation and targeted independent re-review below. Linux AppImage/DEB install/remove: **NOT_RUN**.
