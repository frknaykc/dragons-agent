...
- Native workspace picker and credential-store access: macOS arm64 picker/store and Windows x64 store evidence is recorded below. Windows/Linux picker and Linux store remain **NOT_RUN**.
